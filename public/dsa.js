...
var _searchIoC = Module['_searchIoC'] = makeInvalidEarlyAccess('_searchIoC');
var _getRecentSearchesJSON = Module['_getRecentSearchesJSON'] = makeInvalidEarlyAccess('_getRecentSearchesJSON');
var _getFullReportJSON = Module['_getFullReportJSON'] = makeInvalidEarlyAccess('_getFullReportJSON');
var _getTopKThreats = Module['_getTopKThreats'] = makeInvalidEarlyAccess('_getTopKThreats');
var _searchPrefix = Module['_searchPrefix'] = makeInvalidEarlyAccess('_searchPrefix');
var _getGlobalGraphJSON = Module['_getGlobalGraphJSON'] = makeInvalidEarlyAccess('_getGlobalGraphJSON');
...
function assignWasmExports(wasmExports) {
  ...
  _initEngine = Module['_initEngine'] = createExportWrapper('initEngine', 0);
  assert(typeof wasmExports['searchIoC'] != 'undefined', 'missing Wasm export: searchIoC');
  _searchIoC = Module['_searchIoC'] = createExportWrapper('searchIoC', 1);
  assert(typeof wasmExports['getRecentSearchesJSON'] != 'undefined', 'missing Wasm export: getRecentSearchesJSON');
  _getRecentSearchesJSON = Module['_getRecentSearchesJSON'] = createExportWrapper('getRecentSearchesJSON', 0);
  assert(typeof wasmExports['getFullReportJSON'] != 'undefined', 'missing Wasm export: getFullReportJSON');
  _getFullReportJSON = Module['_getFullReportJSON'] = createExportWrapper('getFullReportJSON', 0);
  assert(typeof wasmExports['getTopKThreats'] != 'undefined', 'missing Wasm export: getTopKThreats');
  _getTopKThreats = Module['_getTopKThreats'] = createExportWrapper('getTopKThreats', 1);
  assert(typeof wasmExports['searchPrefix'] != 'undefined', 'missing Wasm export: searchPrefix');
  _searchPrefix = Module['_searchPrefix'] = createExportWrapper('searchPrefix', 1);
  assert(typeof wasmExports['getGlobalGraphJSON'] != 'undefined', 'missing Wasm export: getGlobalGraphJSON');
  _getGlobalGraphJSON = Module['_getGlobalGraphJSON'] = createExportWrapper('getGlobalGraphJSON', 0);
  assert(typeof wasmExports['getClusterGraphJSON'] != 'undefined', 'missing Wasm export: getClusterGraphJSON');
  _getClusterGraphJSON = Module['_getClusterGraphJSON'] = createExportWrapper('getClusterGraphJSON', 1);
  assert(typeof wasmExports['getShortestPath'] != 'undefined', 'missing Wasm export: getShortestPath');
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = createDSAModule;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = createDSAModule;
} else if (typeof define === 'function' && define['amd'])
  define([], () => createDSAModule);
